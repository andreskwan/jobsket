...
@interface SearchJobsDetailTVC : UIViewController <UITableViewDelegate, UITableViewDataSource, SegControlDelegate> {

    UINavigationController *navController; // reference to the nav controller for push/pop
	DetailMapVC *detailMapVC; // map view controller
	...
	// reference to add the animation when you favorite a job
...
@property (nonatomic, retain) IBOutlet DetailMapVC *detailMapVC;
