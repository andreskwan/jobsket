...
void GetRGBColors( UIColor * color, CGFloat * rgb )
{
    ...
    switch( model )
    {
        ...
        case kCGColorSpaceModelUnknown: warn(@"don't taz me bro!"); break;
        case kCGColorSpaceModelCMYK:    warn(@"don't taz me bro!"); break;
        case kCGColorSpaceModelDeviceN: warn(@"don't taz me bro!"); break;
        case kCGColorSpaceModelIndexed: warn(@"don't taz me bro!"); break;
        case kCGColorSpaceModelPattern: warn(@"don't taz me bro!"); break;
    }
