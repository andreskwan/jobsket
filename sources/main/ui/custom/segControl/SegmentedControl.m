...
- (id) initWithSegmentCount:(NSUInteger)segmentCount 
    ...
    if ((self = [super init]))
    {
        ...
        self.frame =
            CGRectMake(0, 0,
                       (segmentsize.width * segmentCount) + (dividerImage.size.width * (segmentCount - 1)),
                       segmentsize.height);
        ...
        for (NSUInteger i = 0; i < segmentCount; i++)
        {
            ...
            button.frame = CGRectMake(horizontalOffset, 0.0, button.frame.size.width,
            ...
            if (i != segmentCount - 1)
            {
                ...
                divider.frame = CGRectMake(horizontalOffset + segmentsize.width, 0.0, dividerImage.size.width,
