...
@interface CoreDataMemoryManagerTest : SenTestCase {
@private
...
@implementation CoreDataMemoryManagerTest
...
- (void) setUp {
	...
	if (!self.coreDataTesting.manager){
		self.coreDataTesting.manager = [CoreDataMemoryManager sharedInstance];
	}
}
